...
import { __METHODS__, tuple } from '../utils/types'
...
export interface CaptchaProperties {
    ...
    initParams: object
    initMethod: string
    initAction: string | ((...args: unknown[]) => unknown)
    verifyParams: object
    verifyMethod: string
    verifyAction: string | ((...args: unknown[]) => unknown)
    checkParams: object
    checkMethod: string
    checkAction: string | ((...args: unknown[]) => unknown)
